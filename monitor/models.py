...
class Ofertas(models.Model):
    ...
    quant_compra = models.DecimalField(
        'Quantidade Compra', max_digits=19, decimal_places=10)

    valor_venda = models.DecimalField(
        'Valor Venda', max_digits=19, decimal_places=4)

    quant_venda = models.DecimalField(
        'Quantidade Venda', max_digits=19, decimal_places=10)
...
class Oportunidade(models.Model):
    ...
    preco_venda = models.DecimalField(
        'Preço da venda', max_digits=19, decimal_places=4, null=True,
        blank=True)
    percentual = models.DecimalField(
        'Diferença (%)', max_digits=19, decimal_places=2, null=True,
        blank=True)
    ...
    def __str__(self):
        return '{} -> {}'.format(
            self.exchange_compra.name, self.exchange_venda.name)
